...
public class Form extends JFrame {
	...
	public Form() {
		...
		errorLabel.setBounds(50, 750, 400, 30);
		pane.add(errorLabel);
	...
	private class SearchListener implements ActionListener {
		...
		public void actionPerformed(ActionEvent arg0) {
			...
			if(firstNameTextField.getText().isEmpty() == false && lastNameTextField.getText().isEmpty() == false &&
					ageTextField.getText().isEmpty() == false && genderComboBox.getSelectedIndex() != 0 && buttonGroup.getSelection() != null) {
				/* Handle with NumberFormatException that can appears */
				try {
			...
			/* In case of some attribute is missing */
			else {
				if(firstNameTextField.getText().isEmpty()) {
					errorLabel.setText("[ERROR] You need to put her/him first name.");
				}
				
				else if(lastNameTextField.getText().isEmpty()) {
					errorLabel.setText("[ERROR] You need to put her/him last name.");
				}
				
				else if(ageTextField.getText().isEmpty()) {
					errorLabel.setText("[ERROR] You need to put her/him age.");
				}
				
				else if(genderComboBox.getSelectedIndex() == 0) {
					errorLabel.setText("[ERROR] You need to put her/him gender.");
				}
				
				else if(buttonGroup.getSelection() == null) {
					errorLabel.setText("[ERROR] You need to put her/him main interest.");
				}
				
				else {
					errorLabel.setText("[ERROR] Something got wrong. Please try again.");
				}
			}
